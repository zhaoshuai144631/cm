               ...
               $.ajax({
                    ...
                    success: function (data) {
                        if(data.status){
                            ...
                            $("#error-message").html("<front color='red'>"+data.message+"</front>")
                        }
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>持明法洲</strong> Login Form</h1>
                    <div class="description">
                        <p>
                            <a href="#"><strong>佛法圣土</strong></a>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 287px;height: 50px;border:3px solid #ddd;border-radius: 4px; padding: 0 20px"
